 ...
 */
public abstract class DapProtocolMessage<Self extends DapProtocolMessage<?>> {
    public enum Type {
    ...
    protected DapProtocolMessage(int seq, Type type) {
        this.seq = seq;
        this.type = type;
    }

    public abstract Self withSeq(int seq);
