...
/**
 * Serialize all fields that are marked {@link JsonInline @JsonInline} directly
 * in the object. It is the responsibility of the defining class to ensure there is
 * no overlap in the field names.
 */
public class InlineTypeAdapter<T> extends TypeAdapter<T> {
    ...
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
        ...
        public <U> TypeAdapter<U> create(Gson gson, TypeToken<U> type) {
            ...
            if (inlineFields.length > 0)
                return new InlineTypeAdapter<>(defaultAdapter, objectAdapter, inlineFields);
    ...
    protected InlineTypeAdapter(TypeAdapter<T> baseAdapter, TypeAdapter<JsonObject> objectAdapter, InlineField[] inlineFields) {
