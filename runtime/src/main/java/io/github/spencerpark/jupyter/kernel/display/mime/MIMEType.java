...
public class MIMEType {
    ...
    private static boolean isRestrictedNameChar(char c) {
        switch (c) {
            case '!':
            case '#':
            case '$':
    ...
    /**
     * Construct a {@link MIMEType} from a string representation. The grammar is from <a
     * href="https://tools.ietf.org/html/rfc6838">RFC 6838 Section 4.2</a>.
     * <pre>
     ...
     * @throws MIMETypeParseException if the string representation doesn't match the specification
     */
